...
APA_ANCESTRY_CITING_PAPERS = ["additional_ancestry_apa"]
...
def main() -> None:
    ...
    df_ancestry_merged.to_csv(config.processed_data_dir / "additional_apa_ancestry_search_result.csv", index=False)
